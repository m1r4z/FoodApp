...
namespace FoodAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetOrderHistory()
        {
            ...
            {
                var userId = HttpContext.User.FindFirst(ClaimTypes.NameIdentifier)!.Value;
                var orderHeaders = await _dbOrderHeader.GetAllAsync(u => u.ApplicationUserId == userId, includeProperties: "OrderDetails,OrderDetails.FoodItem,OrderDetails.FoodItem.SellerProfile,DeliveryRider");
